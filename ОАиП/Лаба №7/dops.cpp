...
int main()
{
	...
	int* arr_1 = new int[n_1];			//Выделение памяти под динамический массив

	for (int i = 0; i < n_1; i++)		//Заполнение динамического массива
	{
		arr_1[i] = rand() - 10000;
	}

	for (int i = 0; i < n_1; i++)		//Вывод динамического массива в консоль
	{
		cout << arr_1[i] << endl;
	}

	for (int i = 0; i < n_1; i++)		//Проверка условия задания
	{
		if (arr_1[i] < 0)
		{
